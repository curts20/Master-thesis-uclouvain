...
% Forward Kinematics 
  ...
  AlF27 = AlF26+BeF46*s.dpt(1,2);
  AlF37 = C7*(AlF35+BeF76*s.dpt(1,2))+S7*(AlF16+BS16*s.dpt(1,2));
  ...
  AlM27_4 = s.dpt(1,2)*S5;
  AlM37_4 = -OpM26_4*s.dpt(1,2)*C7;
  OpM17_5 = S6*C7;
  OpM37_5 = S6*S7;
  AlM37_5 = -s.dpt(1,2)*C6*C7;
...
% Forward Kinematics 
  ...
  AlF29 = AlF26+BS56*s.dpt(2,3);
  AlF39 = C9*(AlF35+BeF86*s.dpt(2,3))+S9*(AlF16+BeF26*s.dpt(2,3));
  ...
  AlM39_4 = s.dpt(2,3)*(OpM16_4*C9-S5*S9);
  OpM19_5 = S6*C9;
  OpM39_5 = S6*S9;
  AlM39_5 = s.dpt(2,3)*S6*C9;
  AlM39_6 = -s.dpt(2,3)*S9;
...
% Forward Kinematics 
  ...
  AlF211 = AlF26+BeF46*s.dpt(1,4);
  AlF311 = C11*(AlF35+BeF76*s.dpt(1,4))+S11*(AlF16+BS16*s.dpt(1,4));
  ...
  AlM211_4 = s.dpt(1,4)*S5;
  AlM311_4 = -OpM26_4*s.dpt(1,4)*C11;
  OpM111_5 = C11*S6;
  OpM311_5 = S11*S6;
  AlM311_5 = -s.dpt(1,4)*C11*C6;
...
% Forward Kinematics 
  ...
  AlF213 = AlF26+BS56*s.dpt(2,5);
  AlF313 = C13*(AlF35+BeF86*s.dpt(2,5))+S13*(AlF16+BeF26*s.dpt(2,5));
  ...
  AlM313_4 = s.dpt(2,5)*(OpM16_4*C13-S13*S5);
  OpM113_5 = C13*S6;
  OpM313_5 = S13*S6;
  AlM313_5 = s.dpt(2,5)*C13*S6;
  AlM313_6 = -s.dpt(2,5)*S13;
...
% Backward Dynamics 
  ...
  FA18 = -(s.frc(1,8)-s.m(8)*(s.l(3,8)*(OpF28+OM18*OM38)+C7*(AlF16+BS16*s.dpt(1,2))-S7*(AlF35+BeF76*s.dpt(1,2))));
  ...
  FB18_4 = s.m(8)*(OpM26_4*s.dpt(1,2)*S7+OpM28_4*s.l(3,8));
  ...
  FB18_5 = s.m(8)*(OpM28_5*s.l(3,8)+s.dpt(1,2)*C6*S7);
  ...
  FB28_6 = s.m(8)*(s.dpt(1,2)*C8+s.l(3,8)*S7);
...
% Backward Dynamics 
  ...
  FA110 = -(s.frc(1,10)-s.m(10)*(s.l(3,10)*(OpF210+OM110*OM310)+C9*(AlF16+BeF26*s.dpt(2,3))-S9*(AlF35+BeF86*s.dpt(2,3))));
  ...
  FB110_4 = s.m(10)*(OpM210_4*s.l(3,10)-s.dpt(2,3)*(OpM16_4*S9+S5*C9));
  ...
  FB110_5 = s.m(10)*(OpM210_5*s.l(3,10)-s.dpt(2,3)*S6*S9);
  ...
  FB110_6 = s.m(10)*(OpM210_6*s.l(3,10)-s.dpt(2,3)*C9);
...
% Backward Dynamics 
  ...
  FA112 = -(s.frc(1,12)-s.m(12)*(s.l(3,12)*(OpF212+OM112*OM312)+C11*(AlF16+BS16*s.dpt(1,4))-S11*(AlF35+BeF76*s.dpt(1,4))));
  ...
  FB112_4 = s.m(12)*(OpM212_4*s.l(3,12)+OpM26_4*s.dpt(1,4)*S11);
  ...
  FB112_5 = s.m(12)*(OpM212_5*s.l(3,12)+s.dpt(1,4)*S11*C6);
  ...
  FB212_6 = s.m(12)*(s.dpt(1,4)*C12+s.l(3,12)*S11);
...
% Backward Dynamics 
  ...
  FA114 = -(s.frc(1,14)-s.m(14)*(s.l(3,14)*(OpF214+OM114*OM314)+C13*(AlF16+BeF26*s.dpt(2,5))-S13*(AlF35+BeF86*s.dpt(2,5))));
  ...
  FB114_4 = s.m(14)*(OpM214_4*s.l(3,14)-s.dpt(2,5)*(OpM16_4*S13+C13*S5));
  ...
  FB114_5 = s.m(14)*(OpM214_5*s.l(3,14)-s.dpt(2,5)*S13*S6);
  ...
  FB114_6 = s.m(14)*(OpM214_6*s.l(3,14)-s.dpt(2,5)*C13);
...
% Backward Dynamics 
 ...
 CF9_310*S9+FA26*s.l(3,6)-OM26*(s.In(3,6)*OM16+s.In(6,6)*OM26+s.In(9,6)*OM36)+OM36*(s.In(2,6)*OM16+s.In(5,6)*OM26+s.In(6,6)*OM36)+s.dpt(2,3)*(FA110*S9...
 -FF9_310*C9)+s.dpt(2,5)*(FA114*S13-FF13_314*C13));
 ...
 s.In(6,6)*OM26+s.In(9,6)*OM36)-OM36*(s.In(1,6)*OM16+s.In(2,6)*OM26+s.In(3,6)*OM36)-s.dpt(1,2)*(FA18*S7-FF7_38*C7)-s.dpt(1,4)*(FA112*S11-FF11_312*C11)...
 );
 ...
 CF9_310*C9-FF11_212*s.dpt(1,4)-FF7_28*s.dpt(1,2)-OM16*(s.In(2,6)*OM16+s.In(5,6)*OM26+s.In(6,6)*OM36)+OM26*(s.In(1,6)*OM16+s.In(2,6)*OM26+s.In(3,6)*...
 OM36)+s.dpt(2,3)*(FA110*C9+FF9_310*S9)+s.dpt(2,5)*(FA114*C13+FF13_314*S13));
  ...
  CM16_1 = CM110_1*C9+CM111_312*S11+CM112_1*C11+CM114_1*C13+CM131_314*S13+CM18_1*C7+CM71_38*S7+CM91_310*S9-FB26_1*s.l(3,6)-s.dpt(2,3)*(FB110_1*S9...
 -FM91_310*C9)-s.dpt(2,5)*(FB114_1*S13-FM131_314*C13);
  CM26_1 = CM111_212+CM131_214+CM71_28+CM91_210+FB16_1*s.l(3,6)+s.dpt(1,2)*(FB18_1*S7-FM71_38*C7)+s.dpt(1,4)*(FB112_1*S11-FM111_312*C11);
  CM36_1 = -(CM110_1*S9-CM111_312*C11+CM112_1*S11+CM114_1*S13-CM131_314*C13+CM18_1*S7-CM71_38*C7-CM91_310*C9-FM111_212*s.dpt(1,4)-FM71_28*...
 s.dpt(1,2)+s.dpt(2,3)*(FB110_1*C9+FM91_310*S9)+s.dpt(2,5)*(FB114_1*C13+FM131_314*S13));
  ...
  CM16_2 = CM110_2*C9+CM112_2*C11+CM112_312*S11+CM114_2*C13+CM132_314*S13+CM18_2*C7+CM72_38*S7+CM92_310*S9-FB26_2*s.l(3,6)-s.dpt(2,3)*(FB110_2*S9...
 -FM92_310*C9)-s.dpt(2,5)*(FB114_2*S13-FM132_314*C13);
  CM26_2 = CM112_212+CM132_214+CM72_28+CM92_210+FB16_2*s.l(3,6)+s.dpt(1,2)*(FB18_2*S7-FM72_38*C7)+s.dpt(1,4)*(FB112_2*S11-FM112_312*C11);
  CM36_2 = -(CM110_2*S9+CM112_2*S11-CM112_312*C11+CM114_2*S13-CM132_314*C13+CM18_2*S7-CM72_38*C7-CM92_310*C9-FM112_212*s.dpt(1,4)-FM72_28*...
 s.dpt(1,2)+s.dpt(2,3)*(FB110_2*C9+FM92_310*S9)+s.dpt(2,5)*(FB114_2*C13+FM132_314*S13));
  ...
  CM16_3 = CM110_3*C9+CM112_3*C11+CM113_312*S11+CM114_3*C13+CM133_314*S13+CM18_3*C7+CM73_38*S7+CM93_310*S9-FB26_3*s.l(3,6)-s.dpt(2,3)*(FB110_3*S9...
 -FM93_310*C9)-s.dpt(2,5)*(FB114_3*S13-FM133_314*C13);
  CM26_3 = CM113_212+CM133_214+CM73_28+CM93_210+FB16_3*s.l(3,6)+s.dpt(1,2)*(FB18_3*S7-FM73_38*C7)+s.dpt(1,4)*(FB112_3*S11-FM113_312*C11);
  CM36_3 = -(CM110_3*S9+CM112_3*S11-CM113_312*C11+CM114_3*S13-CM133_314*C13+CM18_3*S7-CM73_38*C7-CM93_310*C9-FM113_212*s.dpt(1,4)-FM73_28*...
 s.dpt(1,2)+s.dpt(2,3)*(FB110_3*C9+FM93_310*S9)+s.dpt(2,5)*(FB114_3*C13+FM133_314*S13));
 ...
 CM134_314*S13+CM18_4*C7+CM74_38*S7+CM94_310*S9-s.dpt(2,3)*(FB110_4*S9-FM94_310*C9)-s.dpt(2,5)*(FB114_4*S13-FM134_314*C13);
  CM26_4 = CM114_212+CM134_214+CM74_28+CM94_210+s.In(2,6)*OpM16_4+s.In(5,6)*OpM26_4+s.In(6,6)*S5+s.m(6)*OpM26_4*s.l(3,6)*s.l(3,6)+s.dpt(1,2)*(...
 FB18_4*S7-C7*(FB28_4*S8+FB38_4*C8))+s.dpt(1,4)*(FB112_4*S11-C11*(FB212_4*S12+FB312_4*C12));
 ...
 CM94_310*C9+s.dpt(1,2)*(FB28_4*C8-FB38_4*S8)+s.dpt(1,4)*(FB212_4*C12-FB312_4*S12)-s.dpt(2,3)*(FB110_4*C9+FM94_310*S9)-s.dpt(2,5)*(FB114_4*C13+...
 FM134_314*S13);
  CM36_5 = s.In(3,6)*S6+s.In(6,6)*C6-CM110_5*S9-CM112_5*S11-CM114_5*S13+CM115_312*C11+CM135_314*C13-CM18_5*S7+CM75_38*C7+CM95_310*C9+s.dpt(1,2)*(...
 FB28_5*C8-FB38_5*S8)+s.dpt(1,4)*(FB212_5*C12-FB312_5*S12)-s.dpt(2,3)*(FB110_5*C9+FM95_310*S9)-s.dpt(2,5)*(FB114_5*C13+FM135_314*S13);
  CM36_6 = s.In(9,6)-CM110_6*S9-CM112_6*S11-CM114_6*S13-CM18_6*S7+s.dpt(1,2)*(s.m(8)*s.dpt(1,2)*S8*S8+FB28_6*C8)+s.dpt(1,4)*(s.m(12)*s.dpt(1,4)*...
 S12*S12+FB212_6*C12)-s.dpt(2,3)*(FB110_6*C9+S9*(s.m(10)*AlM39_6*C10*C10+FB210_6*S10))-s.dpt(2,5)*(FB114_6*C13+S13*(s.m(14)*AlM313_6*C14*C14+FB214_6*...
 S14))+C11*(CM212_6*S12+CM312_6*C12)+C13*(CM214_6*S14+CM314_6*C14)+C7*(CM28_6*S8+CM38_6*C8)+C9*(CM210_6*S10+CM310_6*C10);
  ...
  CM55_26 = C6*(CM115_212+CM135_214+CM75_28+CM95_210+s.In(2,6)*S6+s.In(5,6)*C6+s.m(6)*s.l(3,6)*s.l(3,6)*C6+s.dpt(1,2)*(FB18_5*S7-C7*(FB28_5*S8+...
 FB38_5*C8))+s.dpt(1,4)*(FB112_5*S11-C11*(FB212_5*S12+FB312_5*C12)))+S6*(s.In(1,6)*S6+s.In(2,6)*C6+s.m(6)*s.l(3,6)*s.l(3,6)*S6+CM110_5*C9+CM112_5*C11+...
 CM114_5*C13+CM115_312*S11+CM135_314*S13+CM18_5*C7+CM75_38*S7+CM95_310*S9-s.dpt(2,3)*(FB110_5*S9-FM95_310*C9)-s.dpt(2,5)*(FB114_5*S13-FM135_314*C13));
