...
% Sensor Kinematics 
    ...
    RLcp6_17 = ROcp6_16*s.dpt(1,1);
    RLcp6_27 = ROcp6_26*s.dpt(1,1);
    RLcp6_37 = ROcp6_36*s.dpt(1,1);
...
% Sensor Kinematics 
    ...
    RLcp8_19 = ROcp8_46*s.dpt(2,2);
    RLcp8_29 = ROcp8_56*s.dpt(2,2);
    RLcp8_39 = ROcp8_66*s.dpt(2,2);
...
% Sensor Kinematics 
    ...
    RLcp9_19 = ROcp9_46*s.dpt(2,2);
    RLcp9_29 = ROcp9_56*s.dpt(2,2);
    RLcp9_39 = ROcp9_66*s.dpt(2,2);
...
% Sensor Kinematics 
    ...
    RLcp10_111 = ROcp10_16*s.dpt(1,3);
    RLcp10_211 = ROcp10_26*s.dpt(1,3);
    RLcp10_311 = ROcp10_36*s.dpt(1,3);
...
% Sensor Kinematics 
    ...
    RLcp11_111 = ROcp11_16*s.dpt(1,3);
    RLcp11_211 = ROcp11_26*s.dpt(1,3);
    RLcp11_311 = ROcp11_36*s.dpt(1,3);
...
% Sensor Kinematics 
    ...
    RLcp12_113 = ROcp12_46*s.dpt(2,4);
    RLcp12_213 = ROcp12_56*s.dpt(2,4);
    RLcp12_313 = ROcp12_66*s.dpt(2,4);
...
% Sensor Kinematics 
    ...
    RLcp13_113 = ROcp13_46*s.dpt(2,4);
    RLcp13_213 = ROcp13_56*s.dpt(2,4);
    RLcp13_313 = ROcp13_66*s.dpt(2,4);
